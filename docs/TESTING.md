...
| `test_code_health.py` | 43 | All 19 rules (clean code, SOLID, complexity, naming, design, security, best practices), config, scoring, category filtering, rule disabling, report format, edge cases |
