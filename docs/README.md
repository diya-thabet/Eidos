...
This folder contains the technical documentation for the Eidos Legacy Code Intelligence Tool.

## Documents

| Document | Description |
|----------|-------------|
| [ARCHITECTURE.md](ARCHITECTURE.md) | System architecture, data model, API reference (Phases 0-2) |
