...
class Repo(Base):
    ...
    snapshots: Mapped[list[RepoSnapshot]] = relationship(back_populates="repo", cascade="all, delete-orphan")
...
class RepoSnapshot(Base):
    ...
    files: Mapped[list[File]] = relationship(back_populates="snapshot", cascade="all, delete-orphan")
...
class File(Base):
    ...
    __table_args__ = (
        Index("ix_files_snapshot_path", "snapshot_id", "path"),
    )
