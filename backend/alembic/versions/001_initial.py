...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("git_provider", sa.String(32), server_default="github", nullable=False),
    ...
    snapshot_status = sa.Enum("pending", "running", "completed", "failed", name="snapshot_status")
    ...
    op.create_table(
        "repo_snapshots",
        sa.Column("id", sa.String(24), primary_key=True),
        sa.Column("repo_id", sa.String(24), sa.ForeignKey("repos.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("snapshot_id", sa.String(24), sa.ForeignKey("repo_snapshots.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("plan_id", sa.String(24), sa.ForeignKey("plans.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_index("ix_usage_user_action", "usage_records", ["user_id", "action"])
    ...
    op.create_index("ix_symbols_snapshot_file", "symbols", ["snapshot_id", "file_path"])
    ...
    op.create_index("ix_edges_snapshot_type", "edges", ["snapshot_id", "edge_type"])
    op.create_index("ix_edges_snapshot_source", "edges", ["snapshot_id", "source_fq_name"])
    op.create_index("ix_edges_snapshot_target", "edges", ["snapshot_id", "target_fq_name"])
    ...
    op.create_index("ix_summaries_snapshot_scope", "summaries", ["snapshot_id", "scope_type"])
    op.create_index("ix_summaries_snapshot_id_scope_id", "summaries", ["snapshot_id", "scope_id"])
    ...
    op.create_index("ix_generated_docs_snapshot", "generated_docs", ["snapshot_id"])
    op.create_index("ix_generated_docs_snapshot_type", "generated_docs", ["snapshot_id", "doc_type"])
